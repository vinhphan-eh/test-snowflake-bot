...
export const drawdownWage = /* GraphQL */ `
  mutation DrawdownWage($ehToken: String!, $orgId: String!, $bankAccountId: String!, $amount: Float!) {
    drawdownWage(ehToken: $ehToken, orgId: $orgId, bankAccountId: $bankAccountId, amount: $amount)
  }
`;
export const drawdownWageV2 = /* GraphQL */ `
  mutation DrawdownWageV2($ehToken: String!, $orgId: String!, $bankAccountId: String!, $amount: Float!) {
    drawdownWageV2(ehToken: $ehToken, orgId: $orgId, bankAccountId: $bankAccountId, amount: $amount) {
      drawdown {
        status
        message
        messageCode
...
export const payAccount = /* GraphQL */ `
  mutation PayAccount($ehToken: String!, $membership: EhMembershipInput!, $bankDetails: PayAllocationInput!) {
    payAccount(ehToken: $ehToken, membership: $membership, bankDetails: $bankDetails)
  }
`;
...
`;
export const createStripeClientToken = /* GraphQL */ `
...
`;
export const makeStripePayment = /* GraphQL */ `
...
`;
export const startWalletCreation = /* GraphQL */ `
...
export const cashbackUpdateAutoEnrol = /* GraphQL */ `
