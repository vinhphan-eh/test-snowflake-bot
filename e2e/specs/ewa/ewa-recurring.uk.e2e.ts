...
const PermanentEHEmployee: EHAccountDetails = {
  ...
  email: 'thang.huynh+kpuk@employmenthero.com',
  password: 'EmploymentHero123',
  targetOrgUuid: 'b56607e2-fbeb-4118-81e0-5e2c17246314',
  kpBusinessId: '430566',
  kpEmployeeId: '9263266',
...
const PermanentKPEmployee: KPAccountDetails = {
  ...
  email: 'thang.huynh+test16@employmenthero.com',
  password: 'EmploymentHero123',
  kpBusinessId: '430566',
  kpEmployeeId: '9263271',
  payFrequency: PayFrequency.Monthly,
  country: 'GB',
};
...
describe('EWA Recurring UK for EH users', () => {
  ...
  describe('Permanent employee', () => {
    describe('When has enough balance', () => {
      ...
      it('should CRUD a scheduling subscription successfully', async () => {
        ...
        await recurringScreen.updateSubscriptionAmount(50, true);
...
describe('EWA Recurring UK for KP users', () => {
  let incomeDashboardScreen: IncomeDashboardScreen;
  let recurringScreen: EWARecurringScreen;
